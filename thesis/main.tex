...
firmware updates for FRDM-MCXN947. This is typically used as a backend for flashing FRDM-MCXN947 in \textbf{west} utility. \cite{link_server}
...
both operations are made with use of Zephyr's \textbf{west} utility. Program flashing is made using \textbf{LinkServer}.

Pre-build configuration is possible using \textbf{Kconfig}, for setting what peripherals and sub-system are to be enabled or disable, and \textbf{Devicetree}, for creating or updating a structured description of the underling hardware.
